...
namespace Ookii.Dialogs
{
    ...
    public partial class TaskDialog : Component, IWin32Window
    {
        ...
        ///   with <see cref="TaskDialog.ButtonStyle"/> set to <see cref="Ookii.Dialogs.TaskDialogButtonStyle.CommandLinks"/>
        ///   or <see cref="Ookii.Dialogs.TaskDialogButtonStyle.CommandLinksNoIcon"/>, you delineate the command from the 
        ...
        /// </summary>
        /// <value>
        /// A <see cref="Ookii.Dialogs.ProgressBarStyle"/> that indicates the type of progress bar shown on the task dialog.
        /// </value>
        /// <remarks>
        /// <para>
        ///   If this property is set to <see cref="Ookii.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>, the marquee will
        ///   scroll as long as the dialog is visible.
        /// </para>
        /// <para>
        ///   If this property is set to <see cref="Ookii.Dialogs.ProgressBarStyle.ProgressBar"/>, the value of the
        ...
        /// <see cref="Ookii.Dialogs.ProgressBarStyle.MarqueeProgressBar"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This property is only used if the <see cref="ProgressBarStyle"/> property is 
        /// <see cref="Ookii.Dialogs.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        /// </summary>
        /// <value>
        /// A <see cref="Ookii.Dialogs.ProgressBarState"/> indicating the state of the task dialog's progress bar.
        /// The default value is <see cref="Ookii.Dialogs.ProgressBarState.Normal"/>.
        /// </value>
        /// <remarks>
        /// This property is only used if the <see cref="Ookii.Dialogs.ProgressBarStyle"/> property is 
        /// <see cref="Ookii.Dialogs.ProgressBarStyle.ProgressBar"/>.
        /// </remarks>
        ...
        {
            return ShowDialog((IWin32Window)null);
        }
