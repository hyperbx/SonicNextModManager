...
namespace Ookii.Dialogs
{
    ...
    public class TaskDialogButton : TaskDialogItem
    {
        ...
        /// </summary>
        /// <value>
        /// One of the <see cref="Ookii.Dialogs.ButtonType"/> values that indicates the type of the button. The default value
        /// is <see cref="Ookii.Dialogs.ButtonType.Custom"/>.
        /// </value>
        ...
        ///   is <see cref="Ookii.Dialogs.ButtonType.Custom"/>. For other button types, it is ignored.
        /// </para>
        /// <para>
        ...
        internal Natives.TaskDialogCommonButtonFlags ButtonFlag
        {
            get
            {
                switch (_type)
                {
                    case ButtonType.Ok:
                        return Natives.TaskDialogCommonButtonFlags.OkButton;
                    case ButtonType.Yes:
                        return Natives.TaskDialogCommonButtonFlags.YesButton;
                    case ButtonType.No:
                        return Natives.TaskDialogCommonButtonFlags.NoButton;
                    case ButtonType.Cancel:
                        return Natives.TaskDialogCommonButtonFlags.CancelButton;
                    case ButtonType.Retry:
                        return Natives.TaskDialogCommonButtonFlags.RetryButton;
                    case ButtonType.Close:
                        return Natives.TaskDialogCommonButtonFlags.CloseButton;
                    default:
                        return 0;
                }
            }
